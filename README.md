...
VeriCore AI is an enterprise SOP knowledge assistant designed to retrieve
information from corporate Standard Operating Procedures and provide
grounded answers with source citations.

## Core Principles

1. Retrieval before generation
2. Every factual answer must have evidence
3. No unsupported claims
4. Exact document/page/section citations
5. Administrative control over the knowledge base
6. Secure authentication
7. Subscription-aware access
